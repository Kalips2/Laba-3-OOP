...
import controllers.FileSearcher;
...
public class Controller {
  ...
  private void searchInD(String DFolderToSearch) {
    ...
    search(DfileSearchScrollPane, new FileAddition(new File(DfolderList.get(DFolderToSearch))),
        limitation);
  }
  ...
  private void searchInC(String CFolderToSearch) {
    ...
    search(CfileSearchScrollPane, new FileAddition(new File(CfolderList.get(CFolderToSearch))),
        limitation);
  }
  ...
  private void search(ScrollPane fileSearchScrollPane, FileAddition fileRootSearch,
                      String limitation) {
